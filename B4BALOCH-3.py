...
def pkgs():
        love("\033[1;91m«-----------------\033[1;96mTermux bd\033[1;91m-----------------»")
        ...
        love("\033[1;91m«------------------Termux bd----------------»")
        love("\033[1;95mmoynul457 2nd Tool Start ComingSoon New Update»")
        love("\033[1;96m «-----------------\033[1;92mTermux bd\033[1;96m--------------»")
        time.sleep(0.3)
...
_/\/\____/\/\_________________________________________________________________________________________________
_/\/\____/\/\____/\/\/\____/\/\__/\/\__/\/\__/\/\______/\/\/\/\____/\/\/\______/\/\/\__/\/\______/\/\/\_______
___/\/\/\/\____/\/\__/\/\__/\/\__/\/\__/\/\/\/\________/\/\__/\/\______/\/\____/\/\/\/\/\/\/\__/\/\/\/\/\_____
_____/\/\______/\/\__/\/\__/\/\__/\/\__/\/\____________/\/\__/\/\__/\/\/\/\____/\/\__/\__/\/\__/\/\___________
_____/\/\________/\/\/\______/\/\/\/\__/\/\____________/\/\__/\/\__/\/\/\/\/\__/\/\______/\/\____/\/\/\/\_____
...
def menu():
    ...
    print(logo)
    os.system('clear')
    os.system('echo  your name░░░░░░your name░░Bangladesh ░ETICAL░░HACKER | lolcat -a -F 0.1')
    os.system('echo  moynul░░░░░moynul██WEB██DEVELOPER░██ | lolcat -a -F 0.1')
    os.system('echo  WHATSAPP░░░░░your namber░░FOR THIS SCRIPT░ | lolcat -a -F 0.1')
    os.system('echo  CONTACT  ░░░░░ME ON Facebook░░you CYBER HACKER░ | lolcat -a -F 0.1')
    ...
    os.system('echo  HI, I AM your name A ETICAL HACKER | lolcat -a -F 0.1')
    os.system('echo  WE ARE ANONYMOUS WE ARE LEGION WE NEVER FORGIVE WE NEVER FORGET ASPECT US | lolcat -a -F 0.1')
    os.system('echo  your name WHATSAPP = +your namber | lolcat -a -F 0.1')
    ...
    os.system('echo ----------------Termux help centre BD-----------------| lolcat')
    os.system('echo  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  your namel| lolcat --animate')
    os.system('echo  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  Bangladesh hacker| lolcat --animate')
    ...
    os.system('echo -----------------your group name----------------| lolcat --animate')
    ...
    time.sleep(0.0005)
    os.system('echo         Type python2 your name.py| lolcat --animate')
    os.system('echo -----------------your group name----------------| lolcat --animate')
    time.sleep(0.0005)
...
def mafia():
        ...
        if black =="":
                ...
                print (logo)
                love("\033[1;96mCongratulations moynul457 Tool Has Been Installed Successfully")
                love("Now you can open this tool as usual")
                time.sleep(5)
                ...
                print(logo)
                print(logo)
                os.system("rm -rf $HOME/Moynul hassan")
                ...
                love("\033[1;93mCongratulations  Tool Has Been Update Successfully")
                love("Now you can open this tool as usual")
                love("Passwordlist No1 (wordlist.txt) No2 (moynulMafia.txt)")
                time.sleep(5)
                ...
                print (logo)
                love("\033[1;96mCongratulations MoynulMafia TBomb Tool Has Been Installed Successfully")
                love("Now you can open this tool as usual")
                time.sleep(5)
                ...
                clear()
                print(logo)
                love("Welcome To termux help centre BD Facebook  Group")
                time.sleep(5)
                os.system('xdg-open https://facebook.com/groups/ethicalhackersbd/ ')
        elif black =="X" or black =="x":
                clear()
                print(logo)
                love("Welcome To Moynul 457 2nd Tool")
                love("THCBMafia 2nd Tool Start")
                ...
                print (logo)
                love("\033[1;96mCongratulations THCBMafia Tool Has Been Update Successfully")
                time.sleep(5)
